...
namespace IOTools {
	...
	/// Returns 16 bits from an open file stream, in big endian formatting.
	///
	/// # Invariants
	/// The stream is assumed to be valid, and with atleast 16 bits of data left.
	...
	/// Reads 32 bits from an open file stream.
	///
	/// # Invariants
	/// The stream is assumed to be valid, and with atleast 32 bits of data left.
	...
	/// Reads an array of byte values from IDX file. 
	///
	...
	///
	/// # Returns
	/// A NeuralNet::NetworkData struct containing a 2d array of flattened images and their 
	/// oneshot encoded targets.
	NeuralNet::NetworkData LoadMnistDataPair(string images_path, string targets_path) {
		...
		return NeuralNet::NetworkData {images, targets};
	}
}
